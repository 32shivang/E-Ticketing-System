...
router.post('/updateTrain', function(req, res, next) {
  ...
  if(req.cookies.login_email){
    ...
    if(r=="admin"){
      ...
      var update=trainModel.update({TrainNumber:number},{$set:{TrainNumber:req.body.Train_number,TrainName:req.body.name,SrcStation:req.body.src_station,SrcStationTime:req.body.src_station_time,
  ...
  router.post('/trainBooking', function(req, res, next) {
    ...
    let totalPrice=0
      ...
      PDetails.save(function(err,res1){
          ...
          var seatsupdate=seatsModel.update({TrainNumber:data2[0].TrainNumber},{$set:{avaBerths:(data2[0].nums * 72) - filledBerths, 
            avaBertha1:(data2[0].numa1 * 72) - filledBertha1,
            avaBertha2:(data2[0].numa2 * 72) - filledBertha2,
            avaBertha3:(data2[0].numa3 * 72) - filledBertha3}})
